...
check(/PA_APP_VERSION='3\.31\.2'/.test(version),'version is not 3.31.2');
check((action.match(/id:'(?:dash|arc|pulse)'/g)||[]).length===3,'Wira does not have three contact attacks');
check((action.match(/id:'(?:sweep|spiral|thorn)'/g)||[]).length===3,'Bunga does not have three contact attacks');
