...
has(index.includes('demo-mode-v3.56.0.js?v=3.57.3')&&index.includes('demo-result-child-v3.56.6.css?v=3.56.6')&&index.includes('js/version.js?v=3.57.3'),'demo assets not cache-busted');
has(sw.includes("'./css/demo-result-child-v3.56.6.css'"),'child-friendly result CSS missing from offline shell');
has(version.includes("'3.57.3'")&&sw.includes('v3.57.3'),'release version is not 3.57.3');
