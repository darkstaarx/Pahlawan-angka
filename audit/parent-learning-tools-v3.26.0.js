...
const source=fs.readFileSync(path.join(root,'js/parent-learning-tools-v3.26.0.js'),'utf8'),fallback=new Set(['D1.MONEY','D1.TIME','D1.SHAPE','D1.DATA','D2.4.1','D2.5.1','D2.5.3','D2.8.2','D2.8.3','D2.7.2','D3.SHAPE','D4.PERIM','D5.AREA','D6.AREA']);
