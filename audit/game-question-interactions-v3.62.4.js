...
assert(/PA_APP_VERSION='3\.62\.5'/.test(version),'release version stale');
assert(/js\/version\.js\?v=3\.62\.5/.test(html)&&/js\/pwa\.js\?v=3\.62\.5/.test(html),'HTML cache bust stale');
