...
assert.equal(uint24le(24)+1,1280,'clean sprite sheet width changed');
assert.equal(uint24le(27)+1,512,'clean sprite sheet height changed');
...
assert(index.includes('js/combat-motion-v1.js?v=3.62.22'),'renderer cache-bust missing');
assert(index.includes('js/version.js?v=3.62.22')&&index.includes('js/pwa.js?v=3.62.22'),'release cache-bust missing');
assert(version.includes("PA_APP_VERSION='3.62.22'"),'release version missing');
