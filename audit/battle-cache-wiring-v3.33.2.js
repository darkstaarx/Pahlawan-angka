...
check(/js\/battle\.js\?v=3\.33\.3/.test(index),'battle.js is not cache-busted to 3.33.3');
check(/js\/version\.js\?v=3\.33\.3/.test(index),'version.js is not cache-busted to 3.33.3');
check(/js\/pwa\.js\?v=3\.33\.3/.test(index),'PWA registration is not refreshed');
...
check(/PA_APP_VERSION='3\.33\.3'/.test(version),'app version is not 3.33.3');
