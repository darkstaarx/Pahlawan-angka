const CACHE_NAME='pahlawan-angka-v3.21.2';
const APP_SHELL=[
  ...
  './js/battle.js','./js/parent.js','./js/guardian-focus.js','./js/app.js','./js/cloud.js','./js/phase-3.6.4.js','./js/sensory-learning-v3.19.0.js','./js/cikgu-manipulatives-v3.19.1.js','./js/daily-spaced-review-v3.20.0.js','./js/dev-experiments-v3.21.2.js','./js/combat-polish-v3.21.2.js','./js/pwa.js'
];
