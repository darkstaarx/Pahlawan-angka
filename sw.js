// App shell v3.32.2 — compact Bunga contact poses.
...
const APP_SHELL=[
  ...
  './assets/heroes/bunga/attack.webp','./assets/heroes/bunga/frames/attack-original-aura-v3.webp','./assets/heroes/bunga/frames/attack-sweep-v2.webp','./assets/heroes/bunga/frames/attack-spiral-v2.webp','./assets/heroes/bunga/frames/attack-thorn-summon-v3.webp',
  ...
  './js/battle.js','./js/parent.js','./js/parent-learning-tools-v3.26.0.js','./js/guardian-focus.js','./js/app.js','./js/beta-trust-v3.29.0.js','./js/cloud.js','./js/commercial-foundation-v3.25.0.js','./js/guardian-onboarding-v3.25.1.js','./js/custom-picker-v3.25.6.js','./js/phase-3.6.4.js','./js/dev-cikgu-dimensi-v3.24.10.js',
