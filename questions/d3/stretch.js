...
// Optional local stretch probes. Keep separate so this file can never overwrite the production D3 bank.
window.PAQuestionBanks.d3Stretch = function(id,s,shift){
