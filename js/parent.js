...
function renderParent(){
 ...
 document.getElementById("summaryTab").innerHTML=`
  <section class="parentJourney card"><div class="parentJourneyCopy"><div class="eyebrow">DEK IBU BAPA · DARJAH ${g}</div><h2>${parentSafe(summary.headline)}</h2><p>${parentSafe(summary.intro)}</p><div class="parentJourneySignal"><span>✦</span><small>Cikgu Dimensi membaca corak jawapan, bukan sekadar markah.</small></div></div><img src="assets/coach/cikgu-dimensi/parent-adviser-v2.png" alt="Cikgu Dimensi menerangkan kemajuan anak"></section>
