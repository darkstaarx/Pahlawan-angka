...
(()=>{
  ...
  if(document.readyState==='loading'){
    ...
    const loadY6Experience=()=>loadScript(y6ExperienceJs,`script[src^="questions/kssr-year6-experience-v${Y6_EXPERIENCE_VERSION}.js"]`,loadSensory);
